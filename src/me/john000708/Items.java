...
public class Items {
    ...
    public static ItemStack UU_FABRICATOR = new CustomItem(Material.PURPLE_STAINED_GLASS, "§5Matter Fabricator", "", "&fCreates UU Matter from Pure Energy", "", "&4End Game Machine", "&8\u21E8 &e\u26A1 &74098 J Buffer", "&8\u21E8 &e\u26A1 &71024 J/s");
    public static ItemStack UU_TRANSMUTATOR = new CustomItem(Material.PINK_STAINED_GLASS, "§cUU Transmutator", "", "&fUses UU Matter to form Items", "", "&4End Game Machine", "&8\u21E8 &e\u26A1 &74098 J Buffer", "&8\u21E8 &e\u26A1 &71024 J/s");
    ...
    public static ItemStack WIRELESS_CHARGER = new CustomItem(Material.CYAN_TERRACOTTA, "§bWireless Charger", "", "&fWirelessly Charges your items", "", "&6Advanced Machine", "&8\u21E8 &e\u26A1 &7100 J/s", "&8\u21E8 &7Power Loss: &c98%");
    public static ItemStack RAIN_MAKER = new CustomItem(Material.BLUE_TERRACOTTA, "&3Rain Maker", "", "&fA machine which controls the weather", "", "&4End Game Machine", "&8\u21E8 &e\u26A1 &7512 J/s");
    ...
    public static ItemStack DEEP_DEPTH_MINER = new CustomItem(new ItemStack(Material.DIAMOND_BLOCK), "&4Deep Depth Miner", "", "&fThis miner extracts ores straight", "&fout of &8Bedrock. &fIt can also mine a rare radioactive", "&felement called &2Thorium", "", "&4End Game Machine", "&8\u21E8 &e\u26A1 &71024 J/s", "&8\u21E8 &7Requires a &cLaser Charge &fto operate");
    ...
    public static ItemStack ENERGY_TRANSMITTER = new CustomItem(Material.RED_TERRACOTTA, "&cEnergy Transmitter", "", "&fThis transmitter can send energy", "&fover to an &aEnergy Receiver", "", "&4End Game Machine", "&8\u21E8 &7Transfer Rate: 200 J/s", "&8\u21E8 &c75% Efficiency");
    public static ItemStack ENERGY_RECEIVER = new CustomItem(Material.LIME_TERRACOTTA, "&aEnergy Receiver", "", "&fThis receiver accepts power from", "&fan &cEnergy transmitter", "", "&4End Game Machine");
    public static ItemStack TERRAFORMER = new CustomItem(Material.GREEN_TERRACOTTA, "&2Terraformer", "", "&fA machine that allows you to change the biome", "&fof a 16x16 area", "", "&4End Game Machine", "&8\u21E8 &7Uses Terraformer Modules");
    ...
    //Armor
    public static ItemStack ELECTRIC_CHESTPLATE = new CustomArmor(new CustomItem(new MaterialData(Material.LEATHER_CHESTPLATE), "&9Electric Chestplate", "", "&8\u21E8 &7Negates all the damage dealt to player.", "", "&c&o&8\u21E8 &e\u26A1 &70 / 250 J"), Color.TEAL);
